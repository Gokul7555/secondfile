...
class searchpage04 extends StatefulWidget {
  const searchpage04({Key? key}) : super(key: key);

  @override
  State<searchpage04> createState() => _searchpage04State();
}

class _searchpage04State extends State<searchpage04> {
  bool clickMe = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: const Text('Beach - Velacherry')),
