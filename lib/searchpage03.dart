...
class searchpage03 extends StatefulWidget {
  const searchpage03({Key? key}) : super(key: key);

  @override
  State<searchpage03> createState() => _searchpage03State();
}

class _searchpage03State extends State<searchpage03> {
  bool clickMe = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: const Text('Beach - Central Tiruttani')),
